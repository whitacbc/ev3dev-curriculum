...
# Also someone should update the libs/mqtt_remote_method_calls.py file on the robot too (at some point before hawkswmg).
...
def left_mouse_click(event, mqtt_client):
    ...
    my_color = "aquamarine"  # Make your color unique
