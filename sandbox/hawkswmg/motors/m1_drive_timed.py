...
#
#       speed_in_inches_per_second = 0.01111 * speed_in_degrees_per_second + 0
#
...
def main():
    ...
    while time_s != 0:
        ...
        time.sleep(distance_s / (0.01111 * all_sp))
        left_motor.stop()
...
# DONE: 5. Write the code necessary to make the robot drive at that speed
# going roughly that distance.
...
# DONE: 6. Modify the program so that it will exit immediately if the answer
# to   any   question is 0.
...
#
# DONE: 8. Call over a TA or instructor to sign your team's checkoff sheet
