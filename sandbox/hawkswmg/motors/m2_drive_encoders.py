...
# DONE: 2. Copy the contents of your m1_drive_timed.py and paste that text
# into this file below these comments.
...
def main():
    ...
    while time_s != 0:
        ...
        all_sp, stop_action='brake')
        left_motor.wait_while(ev3.Motor.stop_action)
        ev3.Sound.beep().wait()
...
# DONE: 4. Instead of using the run_forever, time.sleep, stop pattern switch
# to using the run_to_rel_pos command.
